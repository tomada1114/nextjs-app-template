...
them, bar the single needle case AGENTS.md spells out for a test that has to match a
catalog value byte for byte. That rule lives in AGENTS.md; this skill only points at it.
